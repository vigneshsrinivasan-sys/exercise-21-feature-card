...
**Primary practice:** Reusable capability cards

## What I built

Six capabilities are represented with reusable card classes, borders, transform behavior, and hover states to practice a repeatable feature pattern.
